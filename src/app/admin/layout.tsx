...
export const metadata = {
  title: { default: "Administración", template: "%s · Admin Madrastras" },
...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-dvh">
      <header className="sticky top-0 z-50 border-b border-line bg-noir/92 backdrop-blur-xl">
        <div className="mx-auto flex h-[var(--header-h)] max-w-[1480px] items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4">
            ...
            <span className="hidden rounded-full border border-lip/30 bg-lip/10 px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.16em] text-lip sm:inline">
              Administración
            </span>
          </div>
          <div className="flex items-center gap-4">
